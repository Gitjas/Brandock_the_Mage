...
InMyArea("C#Brandock")
!StateCheck("C#Brandock",CD_STATE_NOTVALID)~ THEN @2001 /* ~Take care, <CHARNAME>. Seeing how your path guides you to Amn, I am sure we will meet there? Who knows, maybe I'll have an influencial position when next we meet - it's always good to have friends, if you are in Amn. Take care down there, will you?~ */ DO ~TakePartyItem("c#br0001") DestroyItem("c#br0001")
...
ActionOverride("C#Brandock",EscapeAreaDestroy(3)~ 

/* Brandock was 7th party member */
== C#BrandJ IF ~Global("C#BrandockJoined","GLOBAL",2)
InMyArea("C#Brandock")
!StateCheck(Myself,CD_STATE_NOTVALID)~ THEN @2001 /* ~Take care, <CHARNAME>. Seeing how your path guides you to Amn, I am sure we will meet there? Who knows, maybe I'll have an influencial position when next we meet - it's always good to have friends, if you are in Amn. Take care down there, will you?~ */ DO ~TakePartyItem("c#br0001") DestroyItem("c#br0001")
TakePartyItem("c#br0007") DestroyItem("c#br0007")
SetGlobal("C#Brandock_BGTTOBG2","GLOBAL",2)
SetGlobal("C#BrandockJoined","GLOBAL",0)
RemoveFamiliar()
