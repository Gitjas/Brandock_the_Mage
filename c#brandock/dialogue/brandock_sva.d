...
== ~c#brandj~ IF ~OR(2) InParty("C#Brandock") Global("C#BrandockJoined","GLOBAL",2) InMyArea("C#Brandock") !StateCheck("C#Brandock",CD_STATE_NOTVALID)~ THEN ~You are here for a completely different matter? And here I was, thinking you came *because* of what happened... Then, please tell the emissary that <CHARNAME> is seeking an audience, will you do so? And... and what should I do now? You *know* Ebrel is dead, right?~
